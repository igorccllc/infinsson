...
function renderDashboard() {
  ...
  el.innerHTML = `
    ...
    <div class="kpi-grid">
      ...
      <div class="kpi">
        <div class="kpi-label">Patrimônio Líquido${divida > 0 ? ' <span style="font-weight:400;font-size:10px;color:var(--text-dim)">(− dívidas)</span>' : ''}</div>
        <div class="kpi-value lg" style="color:var(--accent)">${fmtK(plReal)}</div>
